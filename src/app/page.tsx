        ...
        <nav className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/register">
              <Button
                variant="primary"
                className="bg-[#CF142B] hover:bg-[#9e111f] text-white focus:ring-[#CF142B]"
              >
                Get Started
              </Button>
            </Link>
      ...
      <main className="container mx-auto px-4 py-20">
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Get personalized learning paths, expert mentorship, and AI-powered
            career recommendations to accelerate your journey in tech.
          </p>
          <div className="flex gap-4 justify-center">
            ...
            <Link href="/about">
              <Button
                size="lg"
                variant="outline"
                className="border-[#CF142B] text-[#CF142B] hover:bg-red-50 focus:ring-[#CF142B]"
              >
                Learn More
              </Button>
            </Link>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <Card className="text-center hover:shadow-lg transition-shadow">
            <div className="flex flex-col items-center gap-4">
              ...
              <h3 className="text-lg text-black font-semibold">Personalized Learning</h3>
          ...
          <Card className="text-center hover:shadow-lg transition-shadow">
            <div className="flex flex-col items-center gap-4">
              ...
              <h3 className="text-lg text-black font-semibold">Job Matching</h3>
              <p className="text-gray-600 text-sm">
          ...
          <Card className="text-center hover:shadow-lg transition-shadow">
            <div className="flex flex-col items-center gap-4">
              ...
              <h3 className="text-lg text-black font-semibold">Expert Mentorship</h3>
              <p className="text-gray-600 text-sm">
          ...
          <Card className="text-center hover:shadow-lg transition-shadow">
            <div className="flex flex-col items-center gap-4">
              ...
              <h3 className="text-lg text-black font-semibold">Career Roadmap</h3>
              <p className="text-gray-600 text-sm">
